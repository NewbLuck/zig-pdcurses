...
pub const struct_panel = extern struct {
    win: [*c]WINDOW,
    wstarty: c_int,
    wendy: c_int,
    wstartx: c_int,
    wendx: c_int,
    below: [*c]struct_panel,
    above: [*c]struct_panel,
    user: ?*const c_void,
    obscure: [*c]struct_panelobs,
};
pub const struct_panelobs = extern struct {
    above: [*c]struct_panelobs,
    pan: [*c]struct_panel,
};
pub const PANELOBS = struct_panelobs;
pub const PANEL = struct_panel;
pub extern fn bottom_panel(pan: [*c]PANEL) c_int;
pub extern fn del_panel(pan: [*c]PANEL) c_int;
pub extern fn hide_panel(pan: [*c]PANEL) c_int;
pub extern fn move_panel(pan: [*c]PANEL, starty: c_int, startx: c_int) c_int;
pub extern fn new_panel(win: [*c]WINDOW) [*c]PANEL;
pub extern fn panel_above(pan: [*c]const PANEL) [*c]PANEL;
pub extern fn panel_below(pan: [*c]const PANEL) [*c]PANEL;
pub extern fn ground_panel(sp: [*c]SCREEN) [*c]PANEL;
pub extern fn ceiling_panel(sp: [*c]SCREEN) [*c]PANEL;
pub extern fn panel_hidden(pan: [*c]const PANEL) c_int;
pub extern fn panel_userptr(pan: [*c]const PANEL) ?*const c_void;
pub extern fn panel_window(pan: [*c]const PANEL) [*c]WINDOW;
pub extern fn replace_panel(pan: [*c]PANEL, win: [*c]WINDOW) c_int;
pub extern fn set_panel_userptr(pan: [*c]PANEL, uptr: ?*const c_void) c_int;
pub extern fn show_panel(pan: [*c]PANEL) c_int;
pub extern fn top_panel(pan: [*c]PANEL) c_int;
pub extern fn update_panels() void;
pub const PDC_STRINGIZE = @compileError("unable to translate C expr: unexpected token .Hash"); // .\curses.h:45:9
pub const PDC_VERDOT = @compileError("unable to translate C expr: unexpected token .StringLiteral"); // .\curses.h:48:9
pub const PDC_VER_YMD = @compileError("unable to translate C expr: unexpected token .StringLiteral"); // .\curses.h:52:9
...
pub const PDCEX = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // .\curses.h:445:10
pub const getbegyx = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // .\curses.h:1747:9
pub const getmaxyx = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // .\curses.h:1748:9
pub const getparyx = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // .\curses.h:1749:9
pub const getyx = @compileError("unable to translate C expr: expected ')' instead got: Equal"); // .\curses.h:1750:9
pub const getsyx = @compileError("unable to translate C expr: unexpected token .LBrace"); // .\curses.h:1752:9
...
pub const __PDCURSES_PANEL_H__ = @as(c_int, 1);
